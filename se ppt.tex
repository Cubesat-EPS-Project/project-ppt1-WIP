...
\begin{table}[]
	\begin{tabular}{|c|l|l|l|l}
		\cline{1-4}
		\multicolumn{1}{|l|}{\textbf{Activity}}                      & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}October 3rd \&\\  4th week\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}November 1st \&\\  2nd week\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}November 3rd \&\\  4th week\end{tabular}}} &  \\ \cline{1-4}
...
\begin{table}[]
	\begin{tabular}{|c|l|l|l}
		\cline{1-3}
		\multicolumn{1}{|l|}{\textbf{Activity}}                                 & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}December 1st \&\\  2nd week\end{tabular}}} & \multicolumn{1}{c|}{\textbf{\begin{tabular}[c]{@{}c@{}}December 3rd \&\\  4th week\end{tabular}}} &  \\ \cline{1-3}
		\begin{tabular}[c]{@{}c@{}}Literature \\ Review\end{tabular}            & \cellcolor[HTML]{FD6864}                                                                          &                                                                                                   &  \\ \cline{1-3}
		\begin{tabular}[c]{@{}c@{}}Hardware \\ Design\end{tabular}              & \cellcolor[HTML]{FFCC67}                                                                          & \cellcolor[HTML]{FFCC67}                                                                          &  \\ \cline{1-3}
		\begin{tabular}[c]{@{}c@{}}Report \\ Writing\end{tabular}               &                                                                                                   &                                                                                                   &  \\ \cline{1-3}
		\begin{tabular}[c]{@{}c@{}}Procurement \\ of \\ Components\end{tabular} &                                                                                                   &                                                                                                   &  \\ \cline{1-3}
		Fabrication                                                             &                                                                                                   &                                                                                                   &  \\ \cline{1-3}
		\begin{tabular}[c]{@{}c@{}}Software\\ Development\end{tabular}          &                                                                                                   &                                                                                                   &  \\ \cline{1-3}
		Testing                                                                 &                                                                                                   &                                                                                                   &  \\ \cline{1-3}
	\end{tabular}
\end{table}
